          ...
          <div className="profile-main-column">
            <section className="profile-card">
              ...
              <form className="profile-form" onSubmit={saveProfile}>
                ...
                <label className="profile-check"><input name="budgetAlerts" type="checkbox" defaultChecked={preferences.budgetAlerts} aria-label="Enable spending alerts" /><span><strong>Spending alerts</strong><small>Notify me as expenses approach this month’s budget.</small></span></label>
